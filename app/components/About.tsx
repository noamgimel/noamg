        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <motion.blockquote
              ...
              className="mt-8 pr-6 border-r-2 border-accent font-handwriting font-bold text-brand-900/90 text-[1.65rem] md:text-[2.05rem] lg:text-[2.3rem] leading-[1.2]"
            >
            ...
            >
              <p>
                ליוויתי בשנים האחרונות עשרות עסקים וחברות בהגשמת החזון הדיגיטלי
                שלהם. המומחיות שלי היא{" "}
                <strong className="text-brand-700">
                  להבין את העסק שלך לעומק
                </strong>{" "}
                — מה מייחד אותו, מה מבדל אותו, ואיך הוא נתפס בעיני הלקוחות שלך.
                זו הדרך להבין מה הלקוחות שלך צריכים להרגיש כדי לבחור דווקא בך
                ולא במתחרים שלך.
              </p>
              <p>
