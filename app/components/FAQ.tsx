...
const faqs = [
  ...
  },
  {
    ...
    a: "מהר ממה שאתה רגיל אליו. מדובר בתהליך אסטרטגי שכולל אפיון, עיצוב ייחודי ופיתוח מאפס — והוא עבר אופטימיזציה כך שכל יום מנוצל. המטרה היא לא 'לרוץ' על חשבון איכות, אלא לוודא שכל פיקסל וכל מילה משרתים את המטרה העסקית שלך, בלי בזבוז זמן.",
  },
  {
  ...
  {
    q: "יש לך פורטפוליו?",
    a: "כן (ראה סקציית 'עבודות נבחרות'). אבל הדוגמה שאתה הכי תרצה לראות היא לא שלי — היא של מישהו בתחום שלך. בשיחה הראשונה אני מראה לך בדיוק את זה.",
  },
];
